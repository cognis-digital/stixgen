#!/usr/bin/env sh
# Universal installer for stixgen. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/stixgen.git"
echo "Installing stixgen ..."
