"""STIXGEN core — Build STIX 2.1 bundles from a list of IOCs/observables."""
...
RULES = [
    ("STI-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("STI-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("STI-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
